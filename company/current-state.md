...
- Latest status: Milestone 4 release-readiness check completed; waiting for release/tag decision.
- Operating mode: build.
- Current milestone: Milestone 4 - stronger econometric baseline.
...
- Current canonical artifact/output: `docs/milestone-4-release-readiness.md`; `docs/milestone-4-comparison-review.md`; `docs/milestone-4-plan.md`; `docs/milestone-3-release-readiness.md`; `docs/milestone-3-summary.md`; `docs/robustness-uncertainty-protocol.md`; `artifacts/reports/rolling_window_model_ranking.md`; `artifacts/reports/bootstrap_error_differences.md`; `artifacts/reports/baseline_next_day_report.md`; `artifacts/reports/baseline_next_week_report.md`; `artifacts/reports/subperiod_model_comparison.md`.
...
- Known caveats: GARCH adds econometric coverage but does not dominate HAR or ML under current diagnostics; no trading/allocation/economic-value result is supported.
- Next action: User decision: create `v0.4.0-milestone-4`, continue locally, or pause.
- Blockers: none.
...
- Missing / uncertain: no `v0.4.0-milestone-4` tag has been approved or created.
